...
#ifndef TIKKUU_FOCUS_LIVE_ACTIVITY_SWIFT_H
#define TIKKUU_FOCUS_LIVE_ACTIVITY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tikkuu_Focus_Live_Activity",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
