...
#ifndef TIKKUU_FOCUS_SWIFT_H
#define TIKKUU_FOCUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tikkuu_Focus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12Tikkuu_Focus15LocationManager")
...
@class CLLocation;
@interface LocationManager (SWIFT_EXTENSION(Tikkuu_Focus)) <CLLocationManagerDelegate>
